package org.example.homeworks.module_2.homework_1;

import org.example.homeworks.module_2.homework_1.ex1.RunnerZoo;
import org.example.homeworks.module_2.homework_1.ex2.RunnerList;
...
public class Homework1 {
    public static void main(String[] args) {
        ...
        //В складе должен быть метод: получить все вещи. Данный метод вернет список,
        //в котором будет только каждая четная вещь из склада.
